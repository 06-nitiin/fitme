...
export function OutfitStage({
  ...
  return (
    <section className="relative isolate min-h-[42rem] overflow-hidden rounded-[2.4rem] border-2 border-fitme-plum/55 bg-[linear-gradient(180deg,#ffdfec_0%,#eee4ff_52%,#d7eaff_100%)] p-5 shadow-[0_6px_0_rgb(87_41_88_/_21%)]">
      <div
      ...
      <span
        className="absolute right-8 top-10 z-40 font-display text-2xl text-amber-400"
        aria-hidden="true"
      >
        ✦
      </span>
      ...
      <span
        className="absolute left-10 top-32 z-40 font-display text-xl text-fitme-blush"
        aria-hidden="true"
      >
        ♥
      </span>

      <div className="relative z-10 mx-auto mt-20 h-[34rem] max-w-[21rem] overflow-hidden rounded-[2rem] bg-white/10">
        <CharacterScene
          avatar={avatar}
          outfit={{
            top,
